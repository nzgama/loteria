...
public function query($sql)
{
  ...
  if (!$this->query_id)
    ...
    die( "Error on this Query:<pre> " . $sql ."</pre> <br/>" 
    ."<pre>" . $this->con->error . "</pre>" );
    /*die( "Error on this Query:<pre> " . $sql ."</pre> <br/>" 
    ."<pre>" . mysqli_error( $this->con ) . "</pre>" );*/
  ...
  public function while_loop($mysql_result) {
    ...
    while( $result = $this->fetch_assoc($mysql_result) ) {
      /* gets a single result (row), and stores it as an associative array */
      //print( "single_result:\n" );
      //print_r( $result );
      $results[] = $result;
    }
